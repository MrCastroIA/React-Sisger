...
import RelatorioPageMap from './pages/Sargento/RelatorioPageMap'; // Página do mapa do Brasil
        ...
        <Routes>
          ...
          */}
          <Route element={<PrivateRoute allowedProfiles={['Sargento']}> <DashboardLayout /> </PrivateRoute>}>
            ...
            <Route path="/sargento/relatorio-map" element={<RelatorioPageMap />} /> {/* Rota para o mapa */}
          </Route>
