...
function HorariosInstrutorPage() { // Note que a função é declarada
  return (
    <div>
...
export default HorariosInstrutorPage; // ESSA LINHA É CRÍTICA! Ela exporta o componente como 'default'