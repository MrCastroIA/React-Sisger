...
function QuadroAulasAlunoPage() { // Note que a função é declarada
  return (
    <div>
...
export default QuadroAulasAlunoPage; // ESSA LINHA É CRÍTICA! Ela exporta o componente como 'default'