...
function GerenciarInstrutoresPage() { // Note que a função é declarada
  return (
    <div>
...
export default GerenciarInstrutoresPage; // ESSA LINHA É CRÍTICA! Ela exporta o componente como 'default'