...
function QuadroAulasSensPage() { // Note que a função é declarada
  return (
    <div>
...
export default QuadroAulasSensPage; // ESSA LINHA É CRÍTICA! Ela exporta o componente como 'default'